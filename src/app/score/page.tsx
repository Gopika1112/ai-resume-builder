            ...
            <main className="flex-1 w-full max-w-5xl mx-auto px-6 py-12 relative z-10 flex flex-col">
                ...
                <div className="mb-10 text-center">
                    <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white mb-4">
                        ATS <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600 drop-shadow-[0_0_20px_rgba(34,197,94,0.3)]">Score Analyzer</span>
                    </h1>
                ...
                <AnimatePresence mode="wait">
                  ...
                  ${isDragging ? 'border-white/50 bg-white/5' : 'border-border hover:border-white/30 hover:bg-card/50'}
                  ${file ? 'border-white/40 bg-white/5' : ''}
                `}
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <button
                                                ...
                                                className="px-6 py-2 bg-green-600 text-white rounded text-sm font-bold font-mono uppercase tracking-wider transition-all hover:bg-green-500 shadow-[0_0_15px_rgba(34,197,94,0.4)] hover:shadow-[0_0_25px_rgba(34,197,94,0.6)] disabled:opacity-50 flex items-center"
                                            >
                                                {isUploading ? (
                                                    <>
                                                ...
                                                <button
                                                    ...
                                                    className={`flex items-center p-4 rounded border transition-all text-left group
                                                        ${selectedResumeId === resume.id
                                                            ...
                                                            : 'border-border/30 hover:border-white/20 hover:bg-card/50'}
                                                    `}
                                                >
                                                    <div className={`p-2 rounded-full mr-4 transition-colors
                                                        ${selectedResumeId === resume.id ? 'bg-green-500/20 text-green-400' : 'bg-secondary text-muted-foreground group-hover:text-white'}
                                                    `}>
                                                        <Database size={18} />
                                                    </div>
                                        ...
                                        {selectedResumeId && (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    disabled={isUploading}
                                                    className="px-8 py-3 bg-green-600 text-white rounded text-sm font-bold font-mono uppercase tracking-widest transition-all hover:bg-green-500 shadow-[0_0_25px_rgba(34,197,94,0.5)] disabled:opacity-50 flex items-center"
                                                >
