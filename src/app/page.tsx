  ...
  const features = [
    {
      ...
      fullColor: "from-green-600 to-emerald-800",
      content: (
    ...
    },
    {
      ...
      fullColor: "from-emerald-600 to-green-800",
      content: (
        <div className="space-y-4 text-left">
          <p className="text-slate-300 font-mono">
    ...
    },
    {
      ...
      icon: <FileCode2 className="h-6 w-6 text-green-400" />,
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center overflow-hidden font-sans">
      ...
      <main className="relative z-10 flex-1 w-full max-w-7xl px-6 md:px-12 py-16 flex flex-col items-center text-center">
        ...
        >
          Build A{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600 drop-shadow-[0_0_20px_rgba(34,197,94,0.3)]">
            Professional Resume
          </span>
        </motion.h1>
        ...
        >
          <Link
            href="/build"
            className="group relative inline-flex items-center justify-center bg-green-600 px-8 py-4 text-base font-bold text-white transition-all hover:bg-green-500 shadow-[0_0_20px_rgba(34,197,94,0.4)] hover:shadow-[0_0_30px_rgba(34,197,94,0.6)] space-x-2 rounded-sm overflow-hidden"
          >
          ...
          <Link
            href="/score"
            className="inline-flex items-center justify-center border border-green-500/50 bg-green-500/10 px-8 py-4 text-base font-bold text-green-400 transition-all hover:bg-green-500/20 uppercase tracking-wider rounded-sm backdrop-blur-sm shadow-[0_0_15px_rgba(34,197,94,0.1)]"
          >
            Check ATS Score
          </Link>
          <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full relative">
            {features.map((feature, i) => (
              <motion.div
                ...
                className="group cursor-pointer flex flex-col items-start p-8 rounded-sm bg-card/60 border border-border backdrop-blur-md hover:border-white/40 transition-all duration-300 shadow-xl overflow-hidden relative"
              >
                {feature.id === "ats-score" && (
                  <div className="absolute top-0 right-0 p-2 bg-white text-black text-xs font-bold uppercase tracking-widest z-10">New</div>
                )}
                ...
                <div className="h-12 w-12 rounded-sm bg-green-500/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(34,197,94,0.1)] relative z-10">
                  {feature.icon}
                </div>
                ...
                <div className="mt-6 flex items-center text-xs font-bold uppercase tracking-widest text-green-400 opacity-0 group-hover:opacity-100 transition-opacity -translate-x-4 group-hover:translate-x-0 duration-300">
