...
export const generateNativePDF = (data: ResumeData) => {
    ...
    const colors = {
        primary: tmpl === "modern" ? [34, 197, 94] :
            tmpl === "creative" ? [79, 70, 229] :
                tmpl === "terminal" ? [34, 197, 94] :
                    tmpl === "modernist" ? [15, 23, 42] :
                        [0, 0, 0],
        text: tmpl === "terminal" ? [34, 197, 100] : [30, 41, 59],
        subtext: tmpl === "terminal" ? [34, 150, 100] : [100, 116, 139],
        bg: tmpl === "terminal" ? [0, 0, 0] : [255, 255, 255]
    };
